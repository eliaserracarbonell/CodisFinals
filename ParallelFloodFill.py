...
def parfloodfill(ring, nturns=1000, delta=0, xmax=10, ymax=5, xstep=0.1, ystep=0.1):
    r"""Finds the Dynamic Aperture of the lattice using a version of Flood Fill
        that tracks up to 8 particles simultaneously.
    ...
    Example:
        b, nl, l = parfloodfill(ring, nturns=500)                         
    """
    ...
    while len(queue) != 0:
        ...
        for l in range (0, len(temp)):
            ...
            if temp['islost'][l]: # If the particle is lost,
                ...
                lost = np.hstack((lost, ([[particles[0][i]], [particles[2][i]], [temp['turn'][l]]])))
